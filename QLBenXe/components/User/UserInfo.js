    ...
    const handleSave = async () => {
        ...
        if (newPassword === confirmPassword) {
            try {
                ...
                // Đóng modal sau khi xử lý hoàn tất
                setIsModalVisible(false);
            }
        } else {
            // Hiển thị thông báo nếu mật khẩu mới không khớp
        ...
        <View style={styles.container}>
            ...
            <View style={styles.in4Container}>
                    ...
                    <View style={styles.btContainer}>
                        <TouchableOpacity style={[{ marginRight: 50 }]} onPress={() => handleChange('ChangePass')}>
                            <Text style={[{ color: 'blue', fontStyle: 'italic', fontSize: 17, fontWeight: 'bold', paddingTop: 10 }]}>
                                Đổi mật khẩu?
                            </Text>
                        </TouchableOpacity>

                        <TouchableOpacity style={styles.button} onPress={handleLogout}>
                            <Text style={[styles.buttonText, { fontWeight: 'bold' }]}>LOG OUT</Text>
                        </TouchableOpacity>
                    </View>
                </View>
            ) : (
